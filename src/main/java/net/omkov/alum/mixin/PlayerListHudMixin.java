...
public abstract class PlayerListHudMixin {
	...
	@Redirect(
		...
		target = "Lnet/minecraft/client/gui/hud/PlayerListHud;renderLatencyIcon" +
			"(Lnet/minecraft/client/gui/DrawContext;IIILnet/minecraft/client/network/PlayerListEntry;)V")
	)
	protected void renderLatencyIcon(
		PlayerListHud self, DrawContext context, int width, int x, int y, PlayerListEntry entry
	) {
		if (!Alum.CONFIG.hud.togglePlayerListPing) { renderLatencyIcon(context, width, x, y, entry); return; }
		...
		context.drawTextWithShadow(client.textRenderer, ping, x, y, 0x00E0E0E0);
